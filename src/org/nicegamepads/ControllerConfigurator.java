...
public class ControllerConfigurator
{
     ...
     */
    public final ControlEvent identifyControl()
     ...
     * @throws InterruptedException  if interrupted while waiting
     */
    public final ControlEvent identifyControl(long timeout, TimeUnit unit,
    ...
    private final class IdentificationListener implements ControlPollingListener
    {
        ...
        public final void controlPolled(ControlEvent event)
        {
            ...
            {
                Boolean test = 
                    boundsReachedByControl.get(event.sourceControl);
                if (test != null)
                {
                    boundsHit = test;
                }
    ...
    implements ControlPollingListener
    {
        /**
         * Calibration results.
         */
        ...
        public final void controlPolled(final ControlEvent event)
        {
            ...
            if (!running || event.sourceControl == null
                    || !eligibleControls.contains(event.sourceControl))
            {
                return;
            }
                    ...
                    protected void runInternal()
                    {
                        for (CalibrationListener listener : calibrationListeners)
                        {
                            listener.calibrationResultsUpdated(
                                    controller, event.sourceControl, newRange);
                        }
                    }
                });
            }
